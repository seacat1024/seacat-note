export namespace CONSTANTS {
    ...
    namespace LAYOUT {
        ...
        const LOGICAL_STRUCTURE_LEFT: string;
    ...
    namespace IMG_PLACEMENT {
        ...
        const BOTTOM_3: string;
        export { BOTTOM_3 as BOTTOM };
    }
    namespace EDIT_NODE_CLASS {
        const SMM_NODE_EDIT_WRAP: string;
        const RICH_TEXT_EDIT_WRAP: string;
        const ASSOCIATIVE_LINE_TEXT_EDIT_WRAP: string;
    }
}
...
export namespace ERROR_TYPES {
    ...
    const EXPORT_LOAD_IMAGE_ERROR: string;
    const DATA_CHANGE_DETAIL_EVENT_ERROR: string;
}
